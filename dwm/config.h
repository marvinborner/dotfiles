...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray3, "-sf", col_gray2, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_n,      spawn,          CMD("alacritty -e `zsh -c 'source /home/melvin/.zshrc && n'`") },
